...
class PrimaryClientController extends Controller
{
    public function index()
    {
        if (auth()->check()) {
            if (auth()->user()->can('primary-client')) {
                ...
                return view('backend.primary_client.index',compact('divisions','serviceCategories'));
            } else {
    ...
    public function edit($id)
    {
        if (auth()->check()) {
            if (auth()->user()->can('primary-client-edit')) {
                ...
                return view('backend.primary_client.edit', compact('customer', 'projects', 'locations', 'divisions', 'districts', 'locations', 'selectedDivisionId', 'selectedDistrictId', 'selectedLocationId', 'serviceCategory'));
            } else {
                auth()->logout(); // Log out the user
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('primary-clients')->with('success', 'Data updated successfully');
    }
    ...
    public function distroy($id)
    {
        if (auth()->check()) {
            if (auth()->user()->can('primary-client-delete')) {
                ...
                $customer->delete();
                return redirect()->route('primary-clients')->with('success', 'Data deleted successfully');
            } else {
                auth()->logout(); // Log out the user
