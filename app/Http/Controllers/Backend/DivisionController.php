...
class DivisionController extends Controller
{
    public function index()
    {
        if (auth()->check()) {
            if (auth()->user()->can('division')) {
                ...
                return redirect()->route('login')->with('error', 'You do not have permission to view the division and have been logged out.');
            }
        } else {
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    $deleteUrl = route('divisions.distroy', $row->id);
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('divisions')->with('success', 'Data created successfully');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('divisions')->with('success', 'Data updated successfully');
    }
    ...
    public function distroy($id)
    {
        ...
        if (auth()->check()) {
            if (auth()->user()->can('division-delete')) {
                $data = Division::findOrFail($id);
                $data->delete();
                return redirect()->route('divisions')->with('success', 'Data deleted successfully');
            } else {
                auth()->logout(); // Log out the user
