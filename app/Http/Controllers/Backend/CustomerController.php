        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ->addColumn('action', function ($row) {
                    ...
                    $addContactClient = '<span style="padding:10px; font-size:13px" class="badge rounded-pill text-bg-primary text-light ms-2">add to contact-client</span>';

                    $addNonProspective = '<span style="padding:10px; font-size:13px" class="badge rounded-pill text-bg-danger text-light ms-2">add to non-prospective</span>';
