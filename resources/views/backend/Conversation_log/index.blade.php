...
<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
  ...
  <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
      <!--begin::Title-->
      <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Conversation-log
      </h1>
      <!--end::Title-->
      <!--begin::Breadcrumb-->
      <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
          ...
          <li class="breadcrumb-item text-muted">
              <a href="{{route('conversation-logs')}}" class="text-muted text-hover-primary">Conversation-log</a>
          </li>
          <!--end::Item-->
          <!--begin::Item-->
...
<script>
  $(document).ready(function() {
      $('#conversation-log').DataTable({
          processing: true,
          serverSide: true,
          ajax: '{{ route('conversation-logs.getdata') }}',
          columns: [{
