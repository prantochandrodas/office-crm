                ...
                @foreach ($customer->projects as $index => $customerProject)
                    <div class="form-group project-group">
                        ...
                        <div class="d-flex">
                            ...
                            <!-- Status Selection -->
                            <select name="statuses[]" class="form-control mb-2 ms-2">
                                <option value="interested"
                                    {{ $customerProject->status == 'interested' ? 'selected' : '' }}>Interested
                                </option>
                                <option value="want-to-buy"
                                    {{ $customerProject->status == 'want-to-buy' ? 'selected' : '' }}>Want to Buy
                                </option>
                                <option value="purchased"
                                    {{ $customerProject->status == 'purchased' ? 'selected' : '' }}>Purchased</option>
                            </select>
