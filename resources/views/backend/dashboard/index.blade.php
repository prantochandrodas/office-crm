                    ...
                    <a href="{{ route('primary-clients') }}"
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span
                                    class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ count($clients) }}</span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
                    ...
                    <a href="{{ route('contact-clients')}}"
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span
                                    class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ count($contactClients) }}</span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
            ...
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                ...
                <div class="col-md-4 col-lg-4 col-xl-4 col-xxl-4 mb-md-5 mb-xl-10">
                    ...
                    <a href="{{ route('wanted-clients') }}"
                        ...
                        <div class="card-body d-flex align-items-end pt-0">
                            <!--begin::Progress-->
                            <svg style="width: 50px; height:50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="{{ route('our-clients') }}"
                        ...
                        <div class="card-header pt-5">
                            ...
                            <div class="card-title d-flex flex-column">
                                <!--begin::Amount-->
                                <span
                                    class="fs-2hx fw-bold text-white me-2 lh-1 ls-n2">{{ count($ourClient) }}</span>
                                <!--end::Amount-->
                                <!--begin::Subtitle-->
