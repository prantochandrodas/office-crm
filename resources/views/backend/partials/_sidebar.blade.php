    ...
    <div class="app-sidebar-menu overflow-hidden flex-column-fluid">
        ...
        <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5"
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
                                ...
                                <a class="menu-link {{ request()->is('service-category') || request()->is('service-category/create') || request()->is('service-category/edit/*') ? 'active' : '' }}"
                                    ...
                                    <span class="menu-icon">
                                        <svg style="width: 24px; height:24px" version="1.0" xmlns="http://www.w3.org/2000/svg"
                                            viewBox="0 0 239.000000 211.000000"
                                            ...
                                            34 35 0 56 -6 80 -25z"/>
                                            <path d="M16 988 c-24 -34 -24 -752 0 -786 15 -22 20 -22 223 -22 148 0 210 3
                                            ...
                                            <path d="M552 593 l3 -348 175 -76 c96 -42 204 -90 240 -107 97 -45 145 -56
                        ...
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                ...
                                <a class="menu-link {{ request()->is('project') || request()->is('project/create') || request()->is('project/edit/*') ? 'active' : '' }}"
                                    ...
                                    <span class="menu-icon">
                                        <svg fill="#28a745" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g> <path d="M2,9H9V2H2ZM4,4H7V7H4Zm6,7,5,8,5-8Zm8-9H11V9h7ZM16,7H13V4h3ZM2,18H9V11H2Zm2-5H7v3H4Z"></path> </g> </g></svg>
                                    </span>
                ...
                <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ request()->is('mail-client') || request()->is('conversation-log/create') ? 'active' : '' }}"
                        href="{{ route('mail-clients') }}">
                        <span class="menu-icon">
                            <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" id="conversation"
                                class="icon glyph" fill="#28a745">
                                <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <span class="menu-title">Mail-Client</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                                        ...
                                        <span class="menu-icon">
                                            <svg style="width: 24px; height:24px" version="1.0"
                                                ...
                                                <g transform="translate(0.000000,484.000000) scale(0.100000,-0.100000)"
                                                    fill="#28a745" stroke="none">
                                                    <path d="M36 4782 c-15 -17 -16 -55 -14 -393 l3 -374 2554 -3 c1880 -1 2557 1
                                                                ...
                                                                75 104 109 170 70z" />
                                                    <path d="M27 3773 c-12 -11 -8 -2642 3 -2664 10 -19 30 -19 835 -19 l824 0 12
                                                                ...
                                                                -3 0 -105z" />
                                                    <path d="M3885 2626 c-56 -25 -68 -48 -75 -149 -7 -99 -16 -126 -52 -149 -65
                                                                ...
                                                                -398 0z" />
                                                    <path d="M2548 1724 c-30 -16 -35 -29 -41 -113 -3 -41 -10 -59 -27 -73 -35
