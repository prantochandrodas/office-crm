...
<div class="app-container container-fluid">
    <div style="background-color: #f0f0f0; padding: 20px;">
        <h2 style="text-align: center;">Edit Primary-Client</h2>
    </div>
    ...
    <div style="background-color: #fff; padding: 20px; border: 1px solid #ccc;">
        <form method="POST" action="{{ route('primary-clients.update', $customer->id) }}" enctype="multipart/form-data">
                ...
                @foreach ($customer->projects as $index => $customerProject)
                    <div class="form-group project-group">
                        ...
                        <div class="d-flex">
                            ...
                            <select name="service_category[]" class="form-select me-2 service-category"
                            ...
                            <select name="projects[]" class="form-select mb-2 project-select">
                                ...
                                @php
                                    ...
                                    $selectedServiceCategoryId =
                                        $projects->firstWhere('id', $customerProject->project_id)
            ...
            <!-- Submit button -->
            <button type="submit" class="btn btn-success mt-4 btn-sm">Update Customer</button>
        </form>
    </div>
</div>
